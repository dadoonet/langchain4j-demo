...
public class Step6ElasticsearchEmbedddingsTest extends AbstractParentTest {
    ...
    @Test
    public void testStoreEmbeddingsInMemory() {
    ...
    @Test
    public void testStoreEmbeddingsInElasticsearch() {
